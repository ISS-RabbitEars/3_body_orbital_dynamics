...
p=[m1,m2,m3,G]
rt=[ro1,vo1,thetao1,omegao1,ro2,vo2,thetao2,omegao2,ro3,vo3,thetao3,omegao3]
...
def run(frame):
	plt.clf()
	plt.subplot(211)
	circle=plt.Circle((x1[frame],y1[frame]),radius=xmax/50,fc='r')
	plt.gca().add_patch(circle)
	circle=plt.Circle((x2[frame],y2[frame]),radius=xmax/50,fc='r')
	plt.gca().add_patch(circle)
	circle=plt.Circle((x3[frame],y3[frame]),radius=xmax/50,fc='r')
	plt.gca().add_patch(circle)
